...
fun Application.configureRouting(
    ...
    routing {
       signIn(mongoRepository, hashingServiceRepository, tokenServiceRepository, tokenConfig)
        ...
        addCreditCard(mongoRepository)
        addCryptoPayment(mongoRepository)
        addGiftCard(mongoRepository)
        getCreditCard(mongoRepository)
        getCryptoCurrency(mongoRepository)
        getGiftCard(mongoRepository)
        deleteSelectedGiftCard(mongoRepository)
        deleteSelectedCreditCard(mongoRepository)
        deleteSelectedCryptoCurrency(mongoRepository)
    }
}
